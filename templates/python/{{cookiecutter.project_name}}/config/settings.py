...
## mcp server config
BK_APIGW_STAGE_MCP_SERVER_NAME="test"
BK_APIGW_STAGE_MCP_SERVER_DESCRIPTION="description"
BK_APIGW_STAGE_MCP_SERVER_IS_PUBLIC=env.bool("BK_APIGW_STAGE_MCP_SERVER_IS_PUBLIC", default=True)
BK_APIGW_STAGE_MCP_SERVER_STATUS=env.bool("BK_APIGW_STAGE_MCP_SERVER_STATUS", default=True)
BK_APIGW_STAGE_ENABLE_MCP_SERVERS=False
# 主动授权
BK_APIGW_STAGE_MCP_SERVER_TARGET_APP_CODES=env.list(
    "BK_APIGW_STAGE_MCP_SERVER_TARGET_APP_CODES", default=[]
)
BK_APIGW_STAGE_ENABLE_MCP_SERVER_LABELS=["label1"]